        ...
        <div className="max-w-[1200px] mx-auto px-7">
          <AnimateIn>
            ...
            <h1 className="text-[30px] font-medium text-cream max-w-[660px] leading-[1.3]">
              Les partenaires qui nous apportent des opportunités d&apos;investissement.
            </h1>
        ...
        <div className="max-w-[1200px] mx-auto px-7">
          ...
          <AnimateIn>
            ...
            <h2 className="text-[27px] font-semibold mt-2.5 mb-8">
              Cinq réseaux, mobilisés selon la classe d&apos;actifs
            </h2>
          </AnimateIn>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
            {partenaires.map((p, i) => (
              <AnimateIn key={p.title} delay={i * 100}>
                <div className="bg-cream rounded-lg p-6 h-full border border-cream-deep transition-all duration-300 hover:shadow-md">
                  <h4 className="text-[15px] font-semibold mb-2">{p.title}</h4>
                  <p className="text-[13.5px] text-warm-grey leading-[1.6]">{p.desc}</p>
                </div>
              </AnimateIn>
            ))}
          </div>
